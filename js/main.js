/* ============================================
   MANJUBA DROPS - Main JavaScript
   GSAP Animations, Interactions, SEO
   ============================================ */
...
(function () {
  ...
  function initScrollAnimations() {
    if (typeof gsap === 'undefined' || typeof ScrollTrigger === 'undefined') {
      // GSAP not loaded - make everything visible
      document.querySelectorAll('.reveal, .reveal-left, .reveal-right, .reveal-scale, .stagger-cards > *').forEach(el => {
        el.style.opacity = '1';
    ...
    // Only animate transforms - NEVER touch opacity (keeps content always visible)
